...
class User extends Authenticatable implements JWTSubject, HasLocalePreference, HasMedia
{
    ...
    public static function getHeaders() {
      $admin = [
        ...
        ['visible' => true, 'value' => 'role', 'type' => 'enum', 'items' => ['1' => trans('app.admin'), '2' => trans('app.customer'), '3' => trans('app.business'), '4' => trans('app.staff')], 'text' => trans('app.role'), 'align' => 'left', 'sortable' => false],
    ...
    public static function getSettings() {
      ...
      $business =['select_all' => true, 'actions' => true, 'create' => true, 'actions_width' => '105px'];
    ...
    public function getAdminStats($statsPeriod = '7days') {
      ...
      $businessSignupsTotalPrevious = (isset($data[0])) ? (int) $data[0] : 0;
